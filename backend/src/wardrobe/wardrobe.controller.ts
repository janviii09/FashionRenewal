...
export class WardrobeController {
  ...
  @Get("browse-preview")
  async getBrowsePreview(@Request() req) {
    const userId = req.user?.userId;
    return this.browseService.getBrowsePreview(userId);
  }
  ...
  async getRecommendations(
    ...
    const result =
      await this.recommendationService.getRecommendationsWithMetadata(
        parseInt(productId),
  ...
  async updateItem(
    ...
    return this.wardrobeService.updateItem(parseInt(id), req.user.userId, data);
  }
