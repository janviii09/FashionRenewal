...
export class MarketplaceController {
    ...
    updateStatus(@Request() req, @Param('id') id: string, @Body() body: { status: OrderStatus }) {
        return this.marketplaceService.updateOrderStatus(+id, body.status, req.user.userId);
    }
